...
<head>
  <title>AR Coffee Culture - Selesai Diproses</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center">
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Menu</a></span> <span>Pesanan Saya</span></p>
          </div>
          ...
          <div class="cart-list">
            <table class="table">
              ...
              <tbody>
                ...
                <tr class="text-center">
                  <td class="image-prod">
                    <div class="img" style="background-image:url(images/produk/<?= $detail['gambar_produk']; ?>);">
                    </div>
                  </td>
                  ...
                  <td class="quantity">
                    <div class="input-group mb-3">
                      <input type="text" name="quantity" class="quantity form-control input-number"
                        value="<?= $detail['qty_transaksi']; ?>" min="1" max="100" disabled>
                    </div>
                  </td>
                </tr><!-- END TR-->
                <?php
                ...
                <tr>
                  <td colspan="6">
                    <div class=" alert alert-info text-center" role="alert">
                      Pesanan Belum Selesai di Proses.</a>
                    </div>
                  </td>
                  <?php } ?>
                </tr>
