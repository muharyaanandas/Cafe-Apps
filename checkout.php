...
<head>
  <title>AR Coffee Culture - Checkout</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center">
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Menu</a></span> <span>Checkout</span></p>
          </div>
        ...
        <div class="col-xl-4 sidebar ftco-animate">
          <div class="sidebar-box ftco-animate">
            <div class="categories mb-5">
              ...
              <li class="text-white">BPD SULSELBAR : 1923222124785439 <br> DANA : 089133444322</li>
            </div>
            <div class="cart-detail cart-total ftco-bg-dark p-3 p-md-4">
              ...
              <p><button type="submit" name="submit" class="btn btn-primary py-3 px-4">Selesaikan Pembayaran</button>
              </p>
            </div>
          </div>
          </form><!-- END -->
