...
<head>
  <title>AR Coffee Culture - Keranjang</title>
  <meta charset="utf-8">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="room.html" id="dropdown04" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">Halo <?= $user['nama_user']; ?></a>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center">
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="#">Menu</a></span> <span>Keranjang</span></p>
          </div>
    ...
    <div class="container">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                if ($sql->num_rows > 0) {
                  ...
                  foreach ($sql as $cart) { ?>
                <tr class="text-center">
                  <td class="product-remove"><a href="delete_cart.php?id=<?= $cart['id_cart']; ?>"><span
                  ...
                  <td class="quantity">
                    <div class="input-group mb-3">
                      <input type="text" name="quantity" class="quantity form-control input-number"
                        value="<?= $cart['qty_cart']; ?>" min="1" max="100" disabled>
                    </div>
                  </td>
                  <?php
                ...
                <tr>
                  <td colspan="6">
                    <div class=" alert alert-info text-center" role="alert">
                      Keranjang belanja kosong. Silahkan pilih barang terlebih dahulu. <a href="index.php#produk">Pilih
                        Produk</a>
                    </div>
                  </td>
                  <?php } ?>
      ...
      <div class="row justify-content-end">
        <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
          ...
          <p class="text-center"><a href="index.php#menu" class="btn btn-outline-primary py-3 px-4">Kembali ke daftar
              menu</a></p>
        </div>
        <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
          <div class="cart-total mb-3">
          ...
          <p class="text-center"><a href="checkout.php" class="btn btn-primary py-3 px-4">Lanjutkan ke Pembayaran</a>
          </p>
        </div>
      </div>
    </div>
