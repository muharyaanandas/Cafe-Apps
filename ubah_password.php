...
<head>
  <title>AR Coffee Culture - Ubah Password</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center">
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Menu</a></span> <span>Password</span></p>
          </div>
    ...
    <div class="container mt-5">
      <div class="row block-9">
        <div class="col-md-6 ftco-animate mx-auto text-center">
          <h4 class="mb-3">Edit Password Anda</h4>
          <form action="#" method="POST" class="contact-form">
            ...
            <div class="form-group">
              <input type="submit" value="Konfirmasi Password" name="submit" class="btn btn-primary py-3 px-5">
            </div>
          </form>
        </div>
      </div>
