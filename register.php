...
<head>
  ...
  <title>AR Coffee Culture - Daftar Akun</title>
        ...
        <div class="col-12 col-md-4 col-lg-5">
          <div class="card shadow">
            <div class="card-body col-10 mx-auto">
              <h4 class="card-title mt-3 mb-3 text-center">Buat Akun Anda</h4>
              <form action="" method="post">
                ...
                <div class="form-group mb-2">
                  <button type="submit" name="submit" class="btn btn-info btn-block" style="width: 200px;"> Daftar </button>
                </div>
                <p class="text-center">Sudah Punya Akun?
                  <a href="login.php" class="text-secondary">Masuk Sekarang</a>
                </p>
              </form>
            </div>
          </div>
