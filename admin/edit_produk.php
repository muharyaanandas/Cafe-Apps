              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="harga_produk" name="harga_produk"
                    placeholder="Harga Produk" required value="<?= $produk['harga_produk']; ?>">
                </div>
                <div class="mb-3">
                  <label for="qty_produk" class="form-label">Qty Produk</label>
                  <input type="text" class="form-control" id="qty_produk" name="qty_produk" placeholder="Qty Produk"
                    required value="<?= $produk['qty_produk']; ?>">
                </div>
                <div class="mb-3">
                  <label for="formFile" class="form-label">Gambar Produk</label>
                  <input class="form-control" type="file" id="formFile" name="produk"
                    value="<?= $produk['gambar_produk']; ?>">
                </div>
                <a href="daftar_produk.php" class="btn btn-outline-secondary">Kembali ke daftar</a>
                <button type="submit" name="submit" class="btn btn-primary" style="width: 150px;">Ubah</button>
              </form>
            </div>
          </div>
        </div>
