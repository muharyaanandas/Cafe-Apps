                    ...
                    <tr>
                      ...
                      <th>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                          data-target="#lihatbuktiModal<?= $transaksi['id_transaksi'] ?>">
                          Lihat Bukti
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="lihatbuktiModal<?= $transaksi['id_transaksi'] ?>" tabindex="-1"
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="card bg-dark text-white">
                                  <img src="../images/bukti_bayar/<?= $transaksi['bukti_bayar']; ?>" class="card-img"
                                    alt="...">
                                </div>
                              </div>
