      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="tambah_pelanggan.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah
              Pelanggan</a>
          </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="lihat_pelanggan.php?id=<?= $user['id_user']; ?>" class="btn btn-success btn-sm">
                          <span class="text">Lihat</span>
                        </a>
                        <a href="edit_pelanggan.php?id=<?= $user['id_user']; ?>" class="btn btn-info btn-sm">
                          <span class="text">Edit</span>
                        </a>
                        <a href="hapus_pelanggan.php?id=<?= $user['id_user']; ?>"
