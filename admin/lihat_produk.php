        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              ...
              <p><strong>Qty:</strong> <?= $produk['qty_produk']; ?></p>
              <p><strong>Gambar Produk:</strong></p>
              <img src="../images/produk/<?= $produk['gambar_produk']; ?>" alt="<?= $produk['nama_produk']; ?>" width="150">
              <br><br>
              <a href="daftar_produk.php" class="btn btn-outline-secondary">Kembali ke Data Produk</a>
            </div>
          </div>
        </div>
        <!-- /.container-fluid -->
